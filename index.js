...
*/
const iAmArray = [{name: 'ant',rating: 8, feedback: 'good'}];
function addReview(arr, a, b, c){
  const obj ={
    name: a,
    rating: b,
    feedback:c,
...
console.log(addReview(iAmArray, 'Daniela', 5, 'Beautiful atmosphere and wonderful vegan options!'))
...
console.log(getReviewByIndex(iAmArray, 0))
